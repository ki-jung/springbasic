package com.kj.springbasic.controller;
...
import com.kj.springbasic.Service.implement.AuthServiceImplement;
...
public class AuthController {
    ...
    // - 인증에 실패한 접근 주체일 경우 anonymousUser를 반환함, 단 해당 url패턴이 permitAll 일때만 가져옴
    public String getAuth(@AuthenticationPrincipal String principal){
        return principal;
    }
